...
public class MenuInicial : MonoBehaviourPunCallbacks
{
    ...
    public GameObject BaseCompañero1;
    public GameObject BaseCompañero2;
    ...
    public void AbrirPanelPersonajes()
    {
        ...
        BaseCompañero1.gameObject.SetActive(false);
        BaseCompañero2.gameObject.SetActive(false);
    ...
    public void DePersonajesAMenuInicial()
    {
        ...
        BaseCompañero1.gameObject.SetActive(true);
        BaseCompañero2.gameObject.SetActive(true);
